 ...
 */
	var TypeAhead = React.createClass({
		...
		calcInputControlWidth: function calcInputControlWidth() {
		...
		render: function render() {
			...
			if (this.state.dropDownVisible) {
				...
				if (typeof this.props.dropdownSameWidthAsInput != "boolean" || this.props.dropdownSameWidthAsInput) dropdownMenuStyle.width = this.state.inputWidth.toString() + 'px';
			}
			...
			return React.createElement(
				'div',
				{ style: styleParent },
				React.createElement('input', { ref: 'input', style: styleInput, type: 'text', placeholder: this.props.placeholder, value: this.state.value, onChange: this.handleInputChange, onKeyDown: this.onInputKeyDown }),
				React.createElement(
					'div',
